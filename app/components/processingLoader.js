...
export function ProcessingLoader({ label = `Conversion du document…`, color = 'text-white' }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-5 animate-fade-in-up">
      ...
      <div className="text-center">
        <p className={`text-sm font-semibold ${color} mb-1 text-center`}>{label}</p>
        <p className={`text-xs muted-foreground ${color} text-center`}>Cela peut prendre quelques secondes</p>
      </div>
