import { getFileExtension, getFileNameWithoutExtension, slugify, slugifyUpper } from './slugify';
...
export function buildLogoFileBaseName(nomClub, typeClub) {
  const clubSlug = slugifyUpper(nomClub);
  ...
  return `${clubSlug}-${normalizedType}`;
}
